$(document).ready(function(){
    ...
    var validator = $("#formtest").validate({
        rules: {
            ...
            password_confirm_ubah: {
                required: true,
                minlength: 5,
                equalTo: "#password_ubah"
            },
            /*AKHIR VALIDASI PETUGAS*/
            /*VALIDASI MERK */
        ...
        messages: {
            ...
            password: {
                ...
                rangelength: jQuery.format("Minimal {0} karakter")
            },
            password_confirm: {
            ...
            email: {
                ...
                minlength: "Silahkan masukkan format email yang benar, ex : contoh@yahoo.com",
                remote: jQuery.format("{0} telah digunakan")
            },
            nama_merk: "Merk harus diisi",
			id_merk: "Silahkan pilih Merk",
...
$('#mdl_petugas').click(function (e) {
    ...
    $.modal ({
        title: 'Data Petugas'
        ,
        ajax: 'modul/mod_petugas/petugas_detail.php?id='+id
    });
});
